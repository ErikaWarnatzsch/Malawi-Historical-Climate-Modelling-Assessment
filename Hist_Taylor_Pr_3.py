...
def main():
    ...
    GPCC = GPCC.extract(t_constraint_ERAINT)
...
#-------------------------------------------------------------------------
    ...
    RCM = [
        ...
        ('RCA4_CSIRO-MK3', CSIROYR_std, CSIROYR_PCC),
    ...
    fig.suptitle("Pr for Malawi 1990-2005", size='x-large')
    PLT.savefig('Pr_Taylor_Annual3', bbox_inches='tight')
    PLT.show()
    ...
    RCM = [
        ...
        ('RCA4_CSIRO-MK3', CSIROSON_std, CSIROSON_PCC),
    ...
    fig.legend(dia.samplePoints,
               [ p.get_label() for p in dia.samplePoints ], numpoints=1, prop=dict(size='small'), bbox_to_anchor=(0.,1.02,1.,.102), loc=8, ncol=3, mode='expand', borderaxespad=0.)
    fig.suptitle("Pr for Malawi SON 1990-2005", size='x-large')
    PLT.savefig('Pr_Taylor_SON3', bbox_inches='tight')
    PLT.show()
    ...
    RCM = [
        ...
        ('RCA4_CSIRO-MK3', CSIRODJF_std, CSIRODJF_PCC),
    ...
    fig.legend(dia.samplePoints,
               [ p.get_label() for p in dia.samplePoints ], numpoints=1, prop=dict(size='small'), bbox_to_anchor=(0.,1.02,1.,.102), loc=8, ncol=3, mode='expand', borderaxespad=0.)
    fig.suptitle("Pr for Malawi DJF 1990-2005", size='x-large')
    PLT.savefig('Pr_Taylor_DJF3', bbox_inches='tight')
    PLT.show()
    ...
    RCM = [
        ...
        ('RCA4_CSIRO-MK3', CSIROMAM_std, CSIROMAM_PCC),
    ...
    fig.legend(dia.samplePoints,
               [ p.get_label() for p in dia.samplePoints ], numpoints=1, prop=dict(size='small'), bbox_to_anchor=(0.,1.02,1.,.102), loc=8, ncol=3, mode='expand', borderaxespad=0.)
    fig.suptitle("Pr for Malawi MAM 1990-2005", size='x-large')
    PLT.savefig('Pr_Taylor_MAM3', bbox_inches='tight')
    PLT.show()
    ...
    RCM = [
        ...
        ('RCA4_CSIRO-MK3', CSIROJJA_std, CSIROJJA_PCC),
    ...
    fig.legend(dia.samplePoints,
               [ p.get_label() for p in dia.samplePoints ], numpoints=1, prop=dict(size='small'), bbox_to_anchor=(0.,1.02,1.,.102), loc=8, ncol=3, mode='expand', borderaxespad=0.)
    fig.suptitle("Pr for Malawi JJA 1990-2005", size='x-large')
    PLT.savefig('Pr_Taylor_JJA3', bbox_inches='tight')
    PLT.show()
