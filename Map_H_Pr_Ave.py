...
def main():
    ...
    UDel = UDel.regrid(CCCma, iris.analysis.Linear())
    GPCC = GPCC.regrid(CCCma, iris.analysis.Linear())
    
    CRUG = CRU.regrid(CanESM2, iris.analysis.Linear())
    UDelG = UDel.regrid(CanESM2, iris.analysis.Linear())
    GPCCG = GPCC.regrid(CanESM2, iris.analysis.Linear())
    ...
    UDelG = UDelG.extract(Malawi)
    GPCCG = GPCCG.extract(Malawi)
    ...
    UDelG = UDelG.extract(t_constraint)
    GPCCG = GPCCG.extract(t_constraint)
   ...
   #limit to a season
    ...
    iriscc.add_season(UDelG, 'time')
    iriscc.add_season(GPCCE, 'time')
    iriscc.add_season(GPCC, 'time')
    iriscc.add_season(GPCCG, 'time')
    ...
    iriscc.add_year(UDelG, 'time')
    iriscc.add_year(GPCCE, 'time')
    iriscc.add_year(GPCC, 'time')
    iriscc.add_year(GPCCG, 'time')
    ...
    UDelGSON = UDelG.extract(SON)
    GPCCGSON = GPCCG.extract (SON)
    ...
    UDelGDJF = UDelG.extract(DJF)
    GPCCGDJF = GPCCG.extract(DJF)
    ...
    UDelGMAM = UDelG.extract(MAM)
    GPCCGMAM = GPCCG.extract(MAM)
    ...
    UDelGJJA = UDelG.extract(JJA)
    GPCCGJJA = GPCCG.extract(JJA)
    ...
    UDelESON = UDelESON.collapsed('year', iris.analysis.MEAN)
    GPCCESON = GPCCESON.collapsed('year', iris.analysis.MEAN)
    CRUSON = CRUSON.collapsed('year', iris.analysis.MEAN)  
    UDelSON = UDelSON.collapsed('year', iris.analysis.MEAN)
    GPCCSON = GPCCSON.collapsed('year', iris.analysis.MEAN)
    CRUGSON = CRUGSON.collapsed('year', iris.analysis.MEAN)  
    UDelGSON = UDelGSON.collapsed('year', iris.analysis.MEAN)
    GPCCGSON = GPCCGSON.collapsed('year', iris.analysis.MEAN)
    ...
    UDelEDJF = UDelEDJF.collapsed('year', iris.analysis.MEAN)
    GPCCEDJF = GPCCEDJF.collapsed('year', iris.analysis.MEAN)
    CRUDJF = CRUDJF.collapsed('year', iris.analysis.MEAN)  
    UDelDJF = UDelDJF.collapsed('year', iris.analysis.MEAN)
    GPCCDJF = GPCCDJF.collapsed('year', iris.analysis.MEAN)
    CRUGDJF = CRUGDJF.collapsed('year', iris.analysis.MEAN)  
    UDelGDJF = UDelGDJF.collapsed('year', iris.analysis.MEAN)
    GPCCGDJF = GPCCGDJF.collapsed('year', iris.analysis.MEAN)
    ...
    UDelEMAM = UDelEMAM.collapsed('year', iris.analysis.MEAN)
    GPCCEMAM = GPCCEMAM.collapsed('year', iris.analysis.MEAN)
    CRUMAM = CRUMAM.collapsed('year', iris.analysis.MEAN)  
    UDelMAM = UDelMAM.collapsed('year', iris.analysis.MEAN)
    GPCCMAM = GPCCMAM.collapsed('year', iris.analysis.MEAN)
    CRUGMAM = CRUGMAM.collapsed('year', iris.analysis.MEAN)  
    UDelGMAM = UDelGMAM.collapsed('year', iris.analysis.MEAN)
    GPCCGMAM = GPCCGMAM.collapsed('year', iris.analysis.MEAN)
    ...
    UDelEJJA = UDelEJJA.collapsed('year', iris.analysis.MEAN) 
    GPCCEJJA = GPCCEJJA.collapsed('year', iris.analysis.MEAN)
    CRUJJA = CRUJJA.collapsed('year', iris.analysis.MEAN) 
    UDelJJA = UDelJJA.collapsed('year', iris.analysis.MEAN)
    GPCCJJA = GPCCJJA.collapsed('year', iris.analysis.MEAN)
    CRUGJJA = CRUGJJA.collapsed('year', iris.analysis.MEAN) 
    UDelGJJA = UDelGJJA.collapsed('year', iris.analysis.MEAN)
    GPCCGJJA = GPCCGJJA.collapsed('year', iris.analysis.MEAN)
    ...
    UDelEYR = UDelE.collapsed('year', iris.analysis.MEAN) 
    GPCCEYR = GPCCE.collapsed('year', iris.analysis.MEAN)
    CRUYR = CRU.collapsed('year', iris.analysis.MEAN) 
    UDelYR = UDel.collapsed('year', iris.analysis.MEAN)
    GPCCYR = GPCC.collapsed('year', iris.analysis.MEAN)
    CRUGYR = CRUG.collapsed('year', iris.analysis.MEAN) 
    UDelGYR = UDelG.collapsed('year', iris.analysis.MEAN)
    GPCCGYR = GPCCG.collapsed('year', iris.analysis.MEAN)
    
    #make units match, they already do but the name of the units doesn't. Only applies to observed data and GCMs
    CanESM2SON.units = Unit('mm year-1')
    CNRMGSON.units = Unit('mm year-1')
    MK3SON.units = Unit('mm year-1')
    EARTHSON.units = Unit('mm year-1')
    EARTH3SON.units = Unit('mm year-1')           
    GFDLSON.units = Unit('mm year-1')
    HadGEM2SON.units = Unit('mm year-1')
    IPSLGSON.units = Unit('mm year-1')
    MIROCGSON.units = Unit('mm year-1')
    MPISON.units = Unit('mm year-1')
    NorESM1SON.units = Unit('mm year-1')
    
    CRUESON.units = Unit('mm year-1')  
    UDelESON.units = Unit('mm year-1')
    GPCCESON.units = Unit('mm year-1')
    CRUSON.units = Unit('mm year-1')
    UDelSON.units = Unit('mm year-1')
    GPCCSON.units = Unit('mm year-1') 
    CRUGSON.units = Unit('mm year-1')
    UDelGSON.units = Unit('mm year-1')
    GPCCGSON.units = Unit('mm year-1') 
    
    CanESM2DJF.units = Unit('mm year-1')
    CNRMGDJF.units = Unit('mm year-1')
    MK3DJF.units = Unit('mm year-1')
    EARTHDJF.units = Unit('mm year-1')
    EARTH3DJF.units = Unit('mm year-1')           
    GFDLDJF.units = Unit('mm year-1')
    HadGEM2DJF.units = Unit('mm year-1')
    IPSLGDJF.units = Unit('mm year-1')
    MIROCGDJF.units = Unit('mm year-1')
    MPIDJF.units = Unit('mm year-1')
    NorESM1DJF.units = Unit('mm year-1')
    
    CRUEDJF.units = Unit('mm year-1') 
    UDelEDJF.units = Unit('mm year-1')
    GPCCEDJF.units = Unit('mm year-1')
    CRUDJF.units = Unit('mm year-1')
    UDelDJF.units = Unit('mm year-1')
    GPCCDJF.units = Unit('mm year-1')
    CRUGDJF.units = Unit('mm year-1')
    UDelGDJF.units = Unit('mm year-1')
    GPCCGDJF.units = Unit('mm year-1')
    
    CanESM2MAM.units = Unit('mm year-1')
    CNRMGMAM.units = Unit('mm year-1')
    MK3MAM.units = Unit('mm year-1')
    EARTHMAM.units = Unit('mm year-1')
    EARTH3MAM.units = Unit('mm year-1')           
    GFDLMAM.units = Unit('mm year-1')
    HadGEM2MAM.units = Unit('mm year-1')
    IPSLGMAM.units = Unit('mm year-1')
    MIROCGMAM.units = Unit('mm year-1')
    MPIMAM.units = Unit('mm year-1')
    NorESM1MAM.units = Unit('mm year-1')
    
    CRUEMAM.units = Unit('mm year-1')  
    UDelEMAM.units = Unit('mm year-1')
    GPCCEMAM.units = Unit('mm year-1')
    CRUMAM.units = Unit('mm year-1')  
    UDelMAM.units = Unit('mm year-1')
    GPCCMAM.units = Unit('mm year-1')
    CRUGMAM.units = Unit('mm year-1')  
    UDelGMAM.units = Unit('mm year-1')
    GPCCGMAM.units = Unit('mm year-1')
    
    CanESM2JJA.units = Unit('mm year-1')
    CNRMGJJA.units = Unit('mm year-1')
    MK3JJA.units = Unit('mm year-1')
    EARTHJJA.units = Unit('mm year-1')
    EARTH3JJA.units = Unit('mm year-1')           
    GFDLJJA.units = Unit('mm year-1')
    HadGEM2JJA.units = Unit('mm year-1')
    IPSLGJJA.units = Unit('mm year-1')
    MIROCGJJA.units = Unit('mm year-1')
    MPIJJA.units = Unit('mm year-1')
    NorESM1JJA.units = Unit('mm year-1')
    
    CRUEJJA.units = Unit('mm year-1')
    UDelEJJA.units = Unit('mm year-1')
    GPCCEJJA.units = Unit('mm year-1')
    CRUJJA.units = Unit('mm year-1')  
    UDelJJA.units = Unit('mm year-1')
    GPCCJJA.units = Unit('mm year-1')
    CRUGJJA.units = Unit('mm year-1')  
    UDelGJJA.units = Unit('mm year-1')
    GPCCGJJA.units = Unit('mm year-1')
      
    CanESM2YR.units = Unit('mm year-1')
    CNRMGYR.units = Unit('mm year-1')
    MK3YR.units = Unit('mm year-1')
    EARTHYR.units = Unit('mm year-1')
    EARTH3YR.units = Unit('mm year-1')           
    GFDLYR.units = Unit('mm year-1')
    HadGEM2YR.units = Unit('mm year-1')
    IPSLGYR.units = Unit('mm year-1')
    MIROCGYR.units = Unit('mm year-1')
    MPIYR.units = Unit('mm year-1')
    NorESM1YR.units = Unit('mm year-1')
    
    CRUEYR.units = Unit('mm year-1')
    UDelEYR.units = Unit('mm year-1')
    GPCCEYR.units = Unit('mm year-1')
    CRUYR.units = Unit('mm year-1') 
    UDelYR.units = Unit('mm year-1')
    GPCCYR.units = Unit('mm year-1')
    CRUGYR.units = Unit('mm year-1') 
    UDelGYR.units = Unit('mm year-1')
    GPCCGYR.units = Unit('mm year-1')
    ...
    ObsSONE = (UDelESON + CRUESON + GPCCESON) /3.    
    ObsDJFE = (UDelEDJF + CRUEDJF + GPCCEDJF) /3.
    ObsMAME = (UDelEMAM + CRUEMAM + GPCCEMAM) /3.
    ObsJJAE = (UDelEJJA + CRUEJJA + GPCCEJJA) /3.
    ObsE = (UDelEYR + CRUEYR + GPCCEYR) /3.
    
    ObsSON = (UDelSON + CRUSON + GPCCSON) /3.    
    ObsDJF = (UDelDJF + CRUDJF + GPCCDJF) /3.
    ObsMAM = (UDelMAM + CRUMAM + GPCCMAM) /3.
    ObsJJA = (UDelJJA + CRUJJA + GPCCJJA) /3.
    Obs = (UDelYR + CRUYR + GPCCYR) /3.
    
    ObsSONG = (UDelGSON + CRUGSON + GPCCGSON) /3.    
    ObsDJFG = (UDelGDJF + CRUGDJF + GPCCGDJF) /3.
    ObsMAMG = (UDelGMAM + CRUGMAM + GPCCGMAM) /3.
    ObsJJAG = (UDelGJJA + CRUGJJA + GPCCGJJA) /3.
    ObsG = (UDelGYR + CRUGYR + GPCCGYR) /3.
        
    #fix unit names, data in Celsius, but called 'Kelvin'...     
    AverageSONE.units = Unit('mm year-1')
    AverageDJFE.units = Unit('mm year-1')
    AverageMAME.units = Unit('mm year-1')
    AverageJJAE.units = Unit('mm year-1')
    AverageE.units = Unit('mm year-1')
    
    AverageSONR.units = Unit('mm year-1')
    AverageDJFR.units = Unit('mm year-1')
    AverageMAMR.units = Unit('mm year-1')
    AverageJJAR.units = Unit('mm year-1')
    AverageR.units = Unit('mm year-1')
    
    AverageSONG.units = Unit('mm year-1')
    AverageDJFG.units = Unit('mm year-1')
    AverageMAMG.units = Unit('mm year-1')
    AverageJJAG.units = Unit('mm year-1')
    AverageG.units = Unit('mm year-1')
    
    ObsSON.units = Unit('mm year-1')
    ObsDJF.units = Unit('mm year-1')
    ObsMAM.units = Unit('mm year-1')
    ObsJJA.units = Unit('mm year-1')
    Obs.units = Unit('mm year-1')
    
    ObsSONE.units = Unit('mm year-1')
    ObsDJFE.units = Unit('mm year-1')
    ObsMAME.units = Unit('mm year-1')
    ObsJJAE.units = Unit('mm year-1')
    ObsE.units = Unit('mm year-1')
    
    ObsSONG.units = Unit('mm year-1')
    ObsDJFG.units = Unit('mm year-1')
    ObsMAMG.units = Unit('mm year-1')
    ObsJJAG.units = Unit('mm year-1')
    ObsG.units = Unit('mm year-1')
...
#    print np.amin(BiasJJAG.data)
    ...
    #PART 4: PLOT MAP
    #load color palettes
    colourA = mpl_cm.get_cmap('Paired')
    colourB = mpl_cm.get_cmap('RdYlGn')
    ...
    plot = iplt.contourf(AverageE, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    ...
    plt.savefig('Pr_Average_ERAINT_MAP_Annual_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsE, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1990-2008 - Observed ', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Observed_ERAINT_MAP_Annual_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageR, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1961-2005 - Average_RCM ', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Average_RCM_MAP_Annual_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageG, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1961-2005 - Average_GCM ', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Average_GCM_MAP_Annual', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(Obs, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1961-2005 - Observed ', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Observed_MAP_Annual_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageSONE, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1990-2008 - Average_ERAINT SON ', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Average_ERAINT_MAP_SON_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageDJFE, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1990-2008 - Average_ERAINT DJF ', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Average_ERAINT_MAP_DJF_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageMAME, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1990-2008 - Average_ERAINT MAM ', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Average_ERAINT_MAP_MAM_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageJJAE, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1990-2008 - Average_ERAINT JJA ', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Average_ERAINT_MAP_JJA_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsSONE, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1990-2008 - Observed SON', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Observed_ERAINT_MAP_SON_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsDJFE, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1990-2008 - Observed DJF', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Observed_ERAINT_MAP_DJF_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsMAME, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1990-2008 - Observed MAM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Observed_ERAINT_MAP_MAM_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsJJAE, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1990-2008 - Observed JJA', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Observed_ERAINT_MAP_JJA_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageSONR, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1961-2005 - Average_RCM_SON', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Average_RCM_MAP_SON_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageDJFR, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1961-2005 - Average_RCM DJF ', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Average_RCM_MAP_DJF_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageMAMR, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1961-2005 - Average_RCM MAM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Average_RCM_MAP_MAM_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageJJAR, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1961-2005 - Average_RCM JJA', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Average_RCM_MAP_JJA_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageSONG, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1961-2005 - Average_GCM_SON', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Average_GCM_MAP_SON', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageDJFG, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1961-2005 - Average_GCM DJF', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Average_GCM_MAP_DJF', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageMAMG, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1961-2005 - Average_GCM MAM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Average_GCM_MAP_MAM', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageJJAG, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1961-2005 - Average_GCM JJA', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Average_GCM_MAP_JJA', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsSON, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1961-2005 - Observed SON', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Observed_MAP_SON_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsDJF, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1961-2005 - Observed DJF', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Observed_MAP_DJF_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsMAM, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1961-2005 - Observed MAM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Observed_MAP_MAM_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsJJA, cmap=colourA, levels=np.arange(0,4200,200), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr 1961-2005 - Observed JJA', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Pr_Observed_MAP_JJA_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasE, cmap=colourB, levels=np.arange(-1250,1250,250), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr Bias 1990-2008 - Average_ERAINT', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('PrBIAS_Average_ERAINT_MAP_Annual_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasR, cmap=colourB, levels=np.arange(-1250,1250,250), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr Bias 1961-2005 - Average_RCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('PrBIAS_Average_RCM_MAP_Annual_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasG, cmap=colourB, levels=np.arange(-1250,1250,250), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr Bias 1961-2005 - Average_GCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('PrBIAS_Average_GCM_MAP_Annual', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasSONE, cmap=colourB, levels=np.arange(-1250,1250,250), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr Bias SON 1990-2008 - Average_ERAINT', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('PrBIAS_Average_ERAINT_MAP_SON_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasDJFE, cmap=colourB, levels=np.arange(-1250,1250,250), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr Bias DJF 1990-2008 - Average_ERAINT', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('PrBIAS_Average_ERAINT_MAP_DJF_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasMAME, cmap=colourB, levels=np.arange(-1250,1250,250), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr Bias MAM 1990-2008 - Average_ERAINT', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('PrBIAS_Average_ERAINT_MAP_MAM_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasJJAE, cmap=colourB, levels=np.arange(-1250,1250,250), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr Bias JJA 1990-2008 - Average_ERAINT', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('PrBIAS_Average_ERAINT_MAP_JJA_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasSONR, cmap=colourB, levels=np.arange(-1250,1250,250), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr Bias SON 1961-2005 - Average_RCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('PrBIAS_Average_RCM_MAP_SON_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasDJFR, cmap=colourB, levels=np.arange(-1250,1250,250), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr Bias DJF 1961-2005 - Average_RCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('PrBIAS_Average_RCM_MAP_DJF_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasMAMR, cmap=colourB, levels=np.arange(-1250,1250,250), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr Bias MAM 1961-2005 - Average_RCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('PrBIAS_Average_RCM_MAP_MAM_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasJJAR, cmap=colourB, levels=np.arange(-1250,1250,250), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr Bias JJA 1961-2005 - Average_RCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('PrBIAS_Average_RCM_MAP_JJA_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasSONG, cmap=colourB, levels=np.arange(-1250,1250,250), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr Bias SON 1961-2005 - Average_GCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('PrBIAS_Average_GCM_MAP_SON', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasDJFG, cmap=colourB, levels=np.arange(-1250,1250,250), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr Bias DJF 1961-2005 - Average_GCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('PrBIAS_Average_GCM_MAP_DJF', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasMAMG, cmap=colourB, levels=np.arange(-1250,1250,250), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr Bias MAM 1961-2005 - Average_GCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('PrBIAS_Average_GCM_MAP_MAM', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasJJAG, cmap=colourB, levels=np.arange(-1250,1250,250), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='mm per year')
    #give map a title
    plt.title('Pr Bias JJA 1961-2005 - Average_GCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('PrBIAS_Average_GCM_MAP_JJA', bbox_inches='tight')
    plt.show()
