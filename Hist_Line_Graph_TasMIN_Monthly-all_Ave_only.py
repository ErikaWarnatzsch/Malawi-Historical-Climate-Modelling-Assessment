...
def main():
    ...
    qplt.plot(CRU_mean.coord('month_number'), CRU_mean, label='Observed', lw=1.5, color='black')
...
#    qplt.plot(CCCma_mean.coord('month_number'), CCCma_mean, lw=1.5, color='blue', alpha=0.3)
#    qplt.plot(CLMcom_mean.coord('month_number'), CLMcom_mean, lw=1.5, color='blue', alpha=0.3)
#    qplt.plot(DMI_mean.coord('month_number'), DMI_mean, lw=1.5, color='blue', alpha=0.3)
#    qplt.plot(KNMI_mean.coord('month_number'), KNMI_mean, lw=1.5, color='blue', alpha=0.3)
#    qplt.plot(MPIE_mean.coord('month_number'), MPIE_mean, lw=1.5, color='blue', alpha=0.3)
#    qplt.plot(SMHI_mean.coord('month_number'), SMHI_mean, lw=1.5, color='blue', alpha=0.3)
#    qplt.plot(CCCmaCanRCM_mean.coord('month_number'), CCCmaCanRCM_mean, color='cyan', alpha=0.3)
#    qplt.plot(CCCmaSMHI_mean.coord('month_number'), CCCmaSMHI_mean, color='cyan', alpha=0.3)
#    qplt.plot(CNRM_mean.coord('month_number'), CNRM_mean, color='cyan', alpha=0.3)
#    qplt.plot(CNRMSMHI_mean.coord('month_number'), CNRMSMHI_mean, color='cyan', alpha=0.3)
#    qplt.plot(CSIRO_mean.coord('month_number'), CSIRO_mean, color='cyan', alpha=0.3)
#    qplt.plot(ICHECDMI_mean.coord('month_number'), ICHECDMI_mean, color='cyan', alpha=0.3)
#    qplt.plot(ICHECCCLM_mean.coord('month_number'), ICHECCCLM_mean, color='cyan', alpha=0.3)
#    qplt.plot(ICHECKNMI_mean.coord('month_number'), ICHECKNMI_mean, color='cyan', alpha=0.3)
#    qplt.plot(ICHECMPI_mean.coord('month_number'), ICHECMPI_mean, color='cyan', alpha=0.3)
#    qplt.plot(ICHECSMHI_mean.coord('month_number'), ICHECSMHI_mean, color='cyan', alpha=0.3) 
#    qplt.plot(IPSL_mean.coord('month_number'), IPSL_mean, color='cyan', alpha=0.3) 
#    qplt.plot(MIROC_mean.coord('month_number'), MIROC_mean, color='cyan', alpha=0.3)
#    qplt.plot(MOHCCCLM_mean.coord('month_number'), MOHCCCLM_mean, color='cyan', alpha=0.3)
#    qplt.plot(MOHCKNMI_mean.coord('month_number'), MOHCKNMI_mean, color='cyan', alpha=0.3)
#    qplt.plot(MOHCSMHI_mean.coord('month_number'), MOHCSMHI_mean, color='cyan', alpha=0.3)
#    qplt.plot(MPICCLM_mean.coord('month_number'), MPICCLM_mean, color='cyan', alpha=0.3)
#    qplt.plot(MPIREMO_mean.coord('month_number'), MPIREMO_mean, color='cyan', alpha=0.3)
#    qplt.plot(MPISMHI_mean.coord('month_number'), MPISMHI_mean, color='cyan', alpha=0.3)
#    qplt.plot(NCCDMI_mean.coord('month_number'), NCCDMI_mean, color='cyan', alpha=0.3)
#    qplt.plot(NCCSMHI_mean.coord('month_number'), NCCSMHI_mean, color='cyan', alpha=0.3)
#    qplt.plot(NOAA_mean.coord('month_number'), NOAA_mean, color='cyan', alpha=0.3) 
#    qplt.plot(CanESM2_mean.coord('month_number'), CanESM2_mean, color='magenta', alpha=0.3) 
#    qplt.plot(CNRMG_mean.coord('month_number'), CNRMG_mean, color='magenta', alpha=0.3)
#    qplt.plot(MK3_mean.coord('month_number'), MK3_mean, color='magenta', alpha=0.3)
#    qplt.plot(EARTH_mean.coord('month_number'), EARTH_mean, color='magenta', alpha=0.3)
#    qplt.plot(EARTH3_mean.coord('month_number'), EARTH3_mean, color='magenta', alpha=0.3)
#    qplt.plot(GFDL_mean.coord('month_number'), GFDL_mean, color='magenta', alpha=0.3)
#    qplt.plot(HadGEM2_mean.coord('month_number'), HadGEM2_mean, color='magenta', alpha=0.3)
#    qplt.plot(IPSLG_mean.coord('month_number'), IPSLG_mean, color='magenta', alpha=0.3)
#    qplt.plot(MIROCG_mean.coord('month_number'), MIROCG_mean, color='magenta', alpha=0.3)
#    qplt.plot(MPI_mean.coord('month_number'), MPI_mean, color='magenta', alpha=0.3)
#    qplt.plot(NorESM1_mean.coord('month_number'), NorESM1_mean, color='magenta', alpha=0.3) 
#    
#    
#    plt.fill_between(X, DMI_mean.data, CCCma_mean.data, color='blue', alpha= 0.2)
#    
#    plt.fill_between(X, NCCDMI_mean.data, CCCmaCanRCM_mean.data, color='cyan', alpha= 0.2)
#    plt.fill_between(X, MOHCKNMI_mean.data, CCCmaCanRCM_mean.data, color='cyan', alpha= 0.2)
#    plt.fill_between(X, ICHECKNMI_mean.data, CCCmaCanRCM_mean.data, color='cyan', alpha= 0.2)
#    
#    plt.fill_between(X, MIROCG_mean.data, CNRMG_mean.data, color='magenta', alpha= 0.2)
#    plt.fill_between(X, EARTH_mean.data, CNRMG_mean.data, color='magenta', alpha= 0.2)
#    plt.fill_between(X, IPSLG_mean.data, CNRMG_mean.data, color='magenta', alpha= 0.2)
    ...
    #create a title
    plt.title('TasMin for Malawi by Month 1990-2005', fontsize=11)   
    
    #add grid lines
    plt.grid()
    
    #save the image of the graph and include full legend
    #plt.savefig('TasMIN_Ave_LineGraph_Monthly3', bbox_inches='tight')
