...
#-------------------------------------------------------------------------
    ...
    ObsSONY = (CRUSON_mean.data + UDelSON_mean.data)/2.
    ObsDJFY = (CRUDJF_mean.data + UDelDJF_mean.data)/2.
    ObsMAMY = (CRUMAM_mean.data + UDelMAM_mean.data)/2.
    ObsJJAY = (CRUJJA_mean.data + UDelJJA_mean.data)/2.    
    ObsY = (CRUYR_mean.data + UDelYR_mean.data)/2.
    ...
    fig.suptitle("Tas for Malawi 1990-2005", size='x-large')
    PLT.savefig('Tas_Taylor_Annual3', bbox_inches='tight')
    PLT.show()
    ...
    fig.legend(dia.samplePoints,
               [ p.get_label() for p in dia.samplePoints ], numpoints=1, prop=dict(size='small'), bbox_to_anchor=(0.,1.02,1.,.102), loc=8, ncol=3, mode='expand', borderaxespad=0.)
    fig.suptitle("Tas for Malawi SON 1990-2005", size='x-large')
    PLT.savefig('Tas_Taylor_SON3', bbox_inches='tight')
    PLT.show()
    ...
    fig.legend(dia.samplePoints,
               [ p.get_label() for p in dia.samplePoints ], numpoints=1, prop=dict(size='small'), bbox_to_anchor=(0.,1.02,1.,.102), loc=8, ncol=3, mode='expand', borderaxespad=0.)
    fig.suptitle("Tas for Malawi DJF 1990-2005", size='x-large')
    PLT.savefig('Tas_Taylor_DJF3', bbox_inches='tight')
    PLT.show()
    ...
    fig.legend(dia.samplePoints,
               [ p.get_label() for p in dia.samplePoints ], numpoints=1, prop=dict(size='small'), bbox_to_anchor=(0.,1.02,1.,.102), loc=8, ncol=3, mode='expand', borderaxespad=0.)
    fig.suptitle("Tas for Malawi MAM 1990-2005", size='x-large')
    PLT.savefig('Tas_Taylor_MAM3', bbox_inches='tight')
    PLT.show()
    ...
    # Add a figure legend and title
    fig.legend(dia.samplePoints,
               [ p.get_label() for p in dia.samplePoints ], numpoints=1, prop=dict(size='small'), bbox_to_anchor=(0.,1.02,1.,.102), loc=8, ncol=4, mode='expand', borderaxespad=0.)
    fig.suptitle("Tas for Malawi JJA 1990-2005", size='x-large')
    PLT.savefig('Tas_Taylor_JJA3', bbox_inches='tight')
    PLT.show()
