...
def main():
    ...
    plt.savefig('Pr_Ave_LineGraph_SON3', bbox_inches='tight')
    ...
    #save the image of the graph and include full legend
    plt.savefig('Pr_Ave_LineGraph_DJF3', bbox_inches='tight')
    ...
    #save the image of the graph and include full legend
    plt.savefig('Pr_Ave_LineGraph_MAM3', bbox_inches='tight')
    ...
    #save the image of the graph and include full legend
    plt.savefig('Pr_Ave_LineGraph_JJA3', bbox_inches='tight')
    ...
    #save the image of the graph and include full legend
    plt.savefig('Pr_Ave_LineGraph_Annual3', bbox_inches='tight')
