...
def main():
    ...
    plot = iplt.contourf(AverageE, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1990-2008 - Average_ERAINT', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Average_ERAINT_MAP_Annual_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsE, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1990-2008 - Observed', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Observed_ERAINT_MAP_Annual_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageR, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1961-2005 - Average_RCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Average_RCM_MAP_Annual_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageG, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1961-2005 - Average_GCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Average_GCM_MAP_Annual', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(Obs, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1961-2005 - Observed', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Observed_MAP_Annual_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageSONE, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1990-2008 - Average_ERAINT SON', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Average_ERAINT_MAP_SON_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageDJFE, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1990-2008 - Average_ERAINT DJF', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Average_ERAINT_MAP_DJF_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageMAME, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1990-2008 - Average_ERAINT MAM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Average_ERAINT_MAP_MAM_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageJJAE, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1990-2008 - Average_ERAINT JJA', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Average_ERAINT_MAP_JJA_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsSONE, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1990-2008 - Observed SON', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Observed_ERAINT_MAP_SON_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsDJFE, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1990-2008 - Observed DJF', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Observed_ERAINT_MAP_DJF_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsMAME, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1990-2008 - Observed MAM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Observed_ERAINT_MAP_MAM_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsJJAE, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1990-2008 - Observed JJA', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Observed_ERAINT_MAP_JJA_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageSONR, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1961-2005 - Average_RCM_SON', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Average_RCM_MAP_SON_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageDJFR, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1961-2005 - Average_RCM DJF', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Average_RCM_MAP_DJF_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageMAMR, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1961-2005 - Average_RCM MAM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Average_RCM_MAP_MAM_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageJJAR, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1961-2005 - Average_RCM JJA', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Average_RCM_MAP_JJA_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageSONG, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1961-2005 - Average_GCM_SON', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Average_GCM_MAP_SON', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageDJFG, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1961-2005 - Average_GCM DJF', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Average_GCM_MAP_DJF', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageMAMG, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1961-2005 - Average_GCM MAM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Average_GCM_MAP_MAM', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageJJAG, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1961-2005 - Average_GCM JJA', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Average_GCM_MAP_JJA', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsSON, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1961-2005 - Observed SON', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Observed_MAP_SON_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsDJF, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1961-2005 - Observed DJF', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Observed_MAP_DJF_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsMAM, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1961-2005 - Observed MAM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Observed_MAP_MAM_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsJJA, cmap=colourA, levels=np.arange(6,25,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN 1961-2005 - Observed JJA', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Observed_MAP_JJA_H', bbox_inches='tight')
    plt.show()
    ...
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN Bias 1990-2008 - Average_ERAINT', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMINBIAS_Average_ERAINT_MAP_Annual_H', bbox_inches='tight')
    plt.show()
    ...
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN Bias 1961-2005 - Average_RCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMINBIAS_Average_RCM_MAP_Annual_H', bbox_inches='tight')
    plt.show()
    ...
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN Bias 1961-2005 - Average_GCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMINBIAS_Average_GCM_MAP_Annual', bbox_inches='tight')
    plt.show()
    ...
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN Bias SON 1990-2008 - Average_ERAINT', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMINBIAS_Average_ERAINT_MAP_SON_H', bbox_inches='tight')
    plt.show()
    ...
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN Bias DJF 1990-2008 - Average_ERAINT', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMINBIAS_Average_ERAINT_MAP_DJF_H', bbox_inches='tight')
    plt.show()
    ...
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN Bias MAM 1990-2008 - Average_ERAINT', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMINBIAS_Average_ERAINT_MAP_MAM_H', bbox_inches='tight')
    plt.show()
    ...
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN Bias JJA 1990-2008 - Average_ERAINT', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMINBIAS_Average_ERAINT_MAP_JJA_H', bbox_inches='tight')
    plt.show()
    ...
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN Bias SON 1961-2005 - Average_RCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMINBIAS_Average_RCM_MAP_SON_H', bbox_inches='tight')
    plt.show()
    ...
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN Bias DJF 1961-2005 - Average_RCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMINBIAS_Average_RCM_MAP_DJF_H', bbox_inches='tight')
    plt.show()
    ...
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN Bias MAM 1961-2005 - Average_RCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMINBIAS_Average_RCM_MAP_MAM_H', bbox_inches='tight')
    plt.show()
    ...
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN Bias JJA 1961-2005 - Average_RCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMINBIAS_Average_RCM_MAP_JJA_H', bbox_inches='tight')
    plt.show()
    ...
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN Bias SON 1961-2005 - Average_GCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMINBIAS_Average_GCM_MAP_SON', bbox_inches='tight')
    plt.show()
    ...
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN Bias DJF 1961-2005 - Average_GCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMINBIAS_Average_GCM_MAP_DJF', bbox_inches='tight')
    plt.show()
    ...
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN Bias MAM 1961-2005 - Average_GCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMINBIAS_Average_GCM_MAP_MAM', bbox_inches='tight')
    plt.show()
    ...
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('TasMIN Bias JJA 1961-2005 - Average_GCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasMINBIAS_Average_GCM_MAP_JJA', bbox_inches='tight')
    plt.show()
