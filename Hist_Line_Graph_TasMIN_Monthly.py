...
def main():
    ...
    qplt.plot(CRUE_mean.coord('month_number'), CRUE_mean, label='Observed', lw=3, color='black')
    ...
    #create a title
    plt.title('TasMin for Malawi by Month 1990-2008', fontsize=11)   
    
    #add grid lines
    plt.grid()
    
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_ERAINT_LineGraph_Monthly', bbox_inches='tight')
    ...
    qplt.plot(CRU_mean.coord('month_number'), CRU_mean, label='Observed', lw=3, color='black')
    ...
    #create a title
    plt.title('TasMin for Malawi by Month 1961-2005', fontsize=11)   
    
    #add grid lines
    plt.grid()
    
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_RCM_LineGraph_Monthly', bbox_inches='tight')
    ...
    qplt.plot(EARTH_mean.coord('month_number'), EARTH_mean, label='EC-EARTH (r12i1p1)', lw=1.5, color='cyan')
    qplt.plot(EARTH3_mean.coord('month_number'), EARTH3_mean, label='EC-EARTH (r3i1p1)', lw=1.5, color='magenta')
    qplt.plot(GFDL_mean.coord('month_number'), GFDL_mean, label='GFDL-ESM2M', lw=1.5, color='yellow')
    qplt.plot(HadGEM2_mean.coord('month_number'), HadGEM2_mean, label='HadGEM2-ES', lw=1.5, color='blue', linestyle='--')
    qplt.plot(IPSLG_mean.coord('month_number'), IPSLG_mean, label='IPSL-CM5A-MR', lw=1.5, color='green', linestyle='--')
    qplt.plot(MIROCG_mean.coord('month_number'), MIROCG_mean, label='MIROC5 ', lw=1.5, color='red', linestyle='--')
    qplt.plot(MPI_mean.coord('month_number'), MPI_mean, label='MPI-ESM-LR', lw=1.5, color='cyan', linestyle='--')
    qplt.plot(NorESM1_mean.coord('month_number'), NorESM1_mean, label='NorESM1-M', lw=1.5, color='magenta', linestyle='--') 
    qplt.plot(CRU_mean.coord('month_number'), CRU_mean, label='Observed', lw=3, color='black')
    ...
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_GCM_LineGraph_Monthly', bbox_inches='tight')
    ...
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Ave_LineGraph_Monthly', bbox_inches='tight')
