...
def main():
    ...
    ObsEY = (CRUE_mean.data + UDelE_mean.data)/2.
    ...
    #create a title
    plt.title('Tas for Malawi by Month 1990-2008', fontsize=11)   
    
    #add grid lines
    plt.grid()
    
    #save the image of the graph and include full legend
    plt.savefig('Tas_ERAINT_LineGraph_Monthly', bbox_inches='tight')
    ...
    #create a title
    plt.title('Tas for Malawi by Month 1961-2005', fontsize=11)   
    
    #add grid lines
    plt.grid()
    
    #save the image of the graph and include full legend
    plt.savefig('Tas_RCM_LineGraph_Monthly', bbox_inches='tight')
    ...
    #save the image of the graph and include full legend
    plt.savefig('Tas_GCM_LineGraph_Monthly', bbox_inches='tight')
    ...
    #save the image of the graph and include full legend
    plt.savefig('Tas_Ave_LineGraph_Monthly', bbox_inches='tight')
