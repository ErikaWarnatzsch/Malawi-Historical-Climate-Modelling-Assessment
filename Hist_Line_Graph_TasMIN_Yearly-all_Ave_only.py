...
def main():
    ...
    XE = np.array([1990,1991,1992,1993,1994,1995,1996,1997,1998,1999,2000,2001,2002,2003,2004,2005])
    ...
    plt.plot(XE, AverageSONEY, label='Average ERAINT', lw=1.5, color='blue')
    qplt.plot(CCCmaSON_mean.coord('year'), CCCmaSON_mean, lw=1.5, color='blue', alpha=0.3)
    qplt.plot(CLMcomSON_mean.coord('year'), CLMcomSON_mean, lw=1.5, color='blue', alpha=0.3)
    qplt.plot(DMISON_mean.coord('year'), DMISON_mean, lw=1.5, color='blue', alpha=0.3)
    qplt.plot(KNMISON_mean.coord('year'), KNMISON_mean, lw=1.5, color='blue', alpha=0.3)
    qplt.plot(MPIESON_mean.coord('year'), MPIESON_mean, lw=1.5, color='blue', alpha=0.3)
    qplt.plot(SMHISON_mean.coord('year'), SMHISON_mean, lw=1.5, color='blue', alpha=0.3)
    qplt.plot(CCCmaCanRCMSON_mean.coord('year'), CCCmaCanRCMSON_mean, color='cyan', alpha=0.3)
    qplt.plot(CCCmaSMHISON_mean.coord('year'), CCCmaSMHISON_mean, color='cyan', alpha=0.3)
    qplt.plot(CNRMSON_mean.coord('year'), CNRMSON_mean, color='cyan', alpha=0.3)
    qplt.plot(CNRMSMHISON_mean.coord('year'), CNRMSMHISON_mean, color='cyan', alpha=0.3)
    qplt.plot(CSIROSON_mean.coord('year'), CSIROSON_mean, color='cyan', alpha=0.3)
    qplt.plot(ICHECDMISON_mean.coord('year'), ICHECDMISON_mean, color='cyan', alpha=0.3)
    qplt.plot(ICHECCCLMSON_mean.coord('year'), ICHECCCLMSON_mean, color='cyan', alpha=0.3)
    qplt.plot(ICHECKNMISON_mean.coord('year'), ICHECKNMISON_mean, color='cyan', alpha=0.3)
    qplt.plot(ICHECMPISON_mean.coord('year'), ICHECMPISON_mean, color='cyan', alpha=0.3)
    qplt.plot(ICHECSMHISON_mean.coord('year'), ICHECSMHISON_mean, color='cyan', alpha=0.3) 
    qplt.plot(IPSLSON_mean.coord('year'), IPSLSON_mean, color='cyan', alpha=0.3) 
    qplt.plot(MIROCSON_mean.coord('year'), MIROCSON_mean, color='cyan', alpha=0.3)
    qplt.plot(MOHCCCLMSON_mean.coord('year'), MOHCCCLMSON_mean, color='cyan', alpha=0.3)
    qplt.plot(MOHCKNMISON_mean.coord('year'), MOHCKNMISON_mean, color='cyan', alpha=0.3)
    qplt.plot(MOHCSMHISON_mean.coord('year'), MOHCSMHISON_mean, color='cyan', alpha=0.3)
    qplt.plot(MPICCLMSON_mean.coord('year'), MPICCLMSON_mean, color='cyan', alpha=0.3)
    qplt.plot(MPIREMOSON_mean.coord('year'), MPIREMOSON_mean, color='cyan', alpha=0.3)
    qplt.plot(MPISMHISON_mean.coord('year'), MPISMHISON_mean, color='cyan', alpha=0.3)
    qplt.plot(NCCDMISON_mean.coord('year'), NCCDMISON_mean, color='cyan', alpha=0.3)
    qplt.plot(NCCSMHISON_mean.coord('year'), NCCSMHISON_mean, color='cyan', alpha=0.3)
    qplt.plot(NOAASON_mean.coord('year'), NOAASON_mean, color='cyan', alpha=0.3) 
    qplt.plot(CanESM2SON_mean.coord('year'), CanESM2SON_mean, color='magenta', alpha=0.3) 
    qplt.plot(CNRMGSON_mean.coord('year'), CNRMGSON_mean, color='magenta', alpha=0.3)
    qplt.plot(MK3SON_mean.coord('year'), MK3SON_mean, color='magenta', alpha=0.3)
    qplt.plot(EARTHSON_mean.coord('year'), EARTHSON_mean, color='magenta', alpha=0.3)
    qplt.plot(EARTH3SON_mean.coord('year'), EARTH3SON_mean, color='magenta', alpha=0.3)
    qplt.plot(GFDLSON_mean.coord('year'), GFDLSON_mean, color='magenta', alpha=0.3)
    qplt.plot(HadGEM2SON_mean.coord('year'), HadGEM2SON_mean, color='magenta', alpha=0.3)
    qplt.plot(IPSLGSON_mean.coord('year'), IPSLGSON_mean, color='magenta', alpha=0.3)
    qplt.plot(MIROCGSON_mean.coord('year'), MIROCGSON_mean, color='magenta', alpha=0.3)
    qplt.plot(MPISON_mean.coord('year'), MPISON_mean, color='magenta', alpha=0.3)
    qplt.plot(NorESM1SON_mean.coord('year'), NorESM1SON_mean, color='magenta', alpha=0.3) 
    ...
    #create a title
    plt.title('TasMin for Malawi SON 1961-2005', fontsize=11)   
    
    #add grid lines
    plt.grid()
    
    #save the image of the graph and include full legend
    #plt.savefig('TasMIN_Ave_LineGraph_SON3', bbox_inches='tight')
    ...
    plt.plot(XE, AverageDJFEY, label='Average ERAINT', lw=1.5, color='blue')
    ...
    #create a title
    plt.title('TasMin for Malawi DJF 1961-2005', fontsize=11)   
    
    #add grid lines
    plt.grid()
    
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Ave_LineGraph_DJF3', bbox_inches='tight')
    ...
    plt.plot(XE, AverageMAMEY, label='Average ERAINT', lw=1.5, color='blue')
    ...
    #create a title
    plt.title('TasMin for Malawi MAM 1961-2005', fontsize=11)   
    
    #add grid lines
    plt.grid()
    
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Ave_LineGraph_MAM3', bbox_inches='tight')
    ...
    plt.plot(XE, AverageJJAEY, label='Average ERAINT', lw=1.5, color='blue')
    ...
    #create a title
    plt.title('TasMin for Malawi JJA 1961-2005', fontsize=11)   
    
    #add grid lines
    plt.grid()
    
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Ave_LineGraph_JJA3', bbox_inches='tight')
    ...
    plt.plot(XE, AverageEY, label='Average ERAINT', lw=1.5, color='blue')
    ...
    #create a title
    plt.title('TasMin for Malawi 1961-2005', fontsize=11)   
    
    #add grid lines
    plt.grid()
    
    #save the image of the graph and include full legend
    plt.savefig('TasMIN_Ave_LineGraph_Annual3', bbox_inches='tight')
