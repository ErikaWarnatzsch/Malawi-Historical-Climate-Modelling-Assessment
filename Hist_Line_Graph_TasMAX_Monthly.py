...
def main():
    ...
    #create a title
    plt.title('TasMax for Malawi by Month 1990-2008', fontsize=11)   
    
    #add grid lines
    plt.grid()
    
    #save the image of the graph and include full legend
    plt.savefig('TasMAX_ERAINT_LineGraph_Monthly', bbox_inches='tight')
    ...
    #create a title
    plt.title('TasMax for Malawi by Month 1961-2005', fontsize=11)   
    
    #add grid lines
    plt.grid()
    
    #save the image of the graph and include full legend
    plt.savefig('TasMAX_RCM_LineGraph_Monthly', bbox_inches='tight')
    ...
    #save the image of the graph and include full legend
    plt.savefig('TasMAX_GCM_LineGraph_Monthly', bbox_inches='tight')
    ...
    #save the image of the graph and include full legend
    plt.savefig('TasMAX_Ave_LineGraph_Monthly', bbox_inches='tight')
