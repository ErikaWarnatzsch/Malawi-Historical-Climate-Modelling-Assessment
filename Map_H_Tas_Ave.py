...
def main():
   ...
   #Load exactly one cube from given file
    ...
    #iriscc.add_year(EARTH3, 'time') #this model is missing year data
    ...
    UDelE.convert_units('Celsius')
    UDel.convert_units('Celsius')
    UDelG.convert_units('Celsius')
   ...
   #limit to a season
    ...
    UDelESON.units = Unit('Celsius')
    CRUSON.units = Unit('Celsius')
    UDelSON.units = Unit('Celsius') 
    CRUGSON.units = Unit('Celsius')
    UDelGSON.units = Unit('Celsius') 
    ...
    UDelEDJF.units = Unit('Celsius')
    CRUDJF.units = Unit('Celsius')
    UDelDJF.units = Unit('Celsius')
    CRUGDJF.units = Unit('Celsius')
    UDelGDJF.units = Unit('Celsius')
    ...
    UDelEMAM.units = Unit('Celsius')
    CRUMAM.units = Unit('Celsius')  
    UDelMAM.units = Unit('Celsius')
    CRUGMAM.units = Unit('Celsius')  
    UDelGMAM.units = Unit('Celsius')
    ...
    UDelEJJA.units = Unit('Celsius')
    CRUJJA.units = Unit('Celsius')  
    UDelJJA.units = Unit('Celsius')
    CRUGJJA.units = Unit('Celsius')  
    UDelGJJA.units = Unit('Celsius')
    ...
    UDelEYR.units = Unit('Celsius')
    CRUYR.units = Unit('Celsius') 
    UDelYR.units = Unit('Celsius')
    CRUGYR.units = Unit('Celsius') 
    UDelGYR.units = Unit('Celsius')
    ...
    ObsSONE = (UDelESON + CRUESON)/2. 
    ObsDJFE = (UDelEDJF + CRUEDJF)/2.
    ObsMAME = (UDelEMAM + CRUEMAM)/2.
    ObsJJAE = (UDelEJJA + CRUEJJA)/2.
    ObsE = (UDelEYR + CRUEYR)/2.
    
    ObsSON = (UDelSON + CRUSON)/2.    
    ObsDJF = (UDelDJF + CRUDJF)/2.
    ObsMAM = (UDelMAM + CRUMAM)/2.
    ObsJJA = (UDelJJA + CRUJJA)/2.
    Obs = (UDelYR + CRUYR)/2.
    
    ObsSONG = (UDelGSON + CRUGSON)/2.    
    ObsDJFG = (UDelGDJF + CRUGDJF)/2.
    ObsMAMG = (UDelGMAM + CRUGMAM)/2.
    ObsJJAG = (UDelGJJA + CRUGJJA)/2.
    ObsG = (UDelGYR + CRUGYR)/2.
    ...
    plot = iplt.contourf(AverageE, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1990-2008 - Average_ERAINT', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Average_ERAINT_MAP_Annual_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsE, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1990-2008 - Observed', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Observed_ERAINT_MAP_Annual_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageR, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1961-2005 - Average_RCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Average_RCM_MAP_Annual_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageG, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1961-2005 - Average_GCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Average_GCM_MAP_Annual', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(Obs, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1961-2005 - Observed', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Observed_MAP_Annual_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageSONE, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1990-2008 - Average_ERAINT SON', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Average_ERAINT_MAP_SON_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageDJFE, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1990-2008 - Average_ERAINT DJF', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Average_ERAINT_MAP_DJF_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageMAME, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1990-2008 - Average_ERAINT MAM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Average_ERAINT_MAP_MAM_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageJJAE, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1990-2008 - Average_ERAINT JJA', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Average_ERAINT_MAP_JJA_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsSONE, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1990-2008 - Observed SON', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Observed_ERAINT_MAP_SON_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsDJFE, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1990-2008 - Observed DJF', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Observed_ERAINT_MAP_DJF_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsMAME, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1990-2008 - Observed MAM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Observed_ERAINT_MAP_MAM_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsJJAE, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1990-2008 - Observed JJA', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Observed_ERAINT_MAP_JJA_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageSONR, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1961-2005 - Average_RCM_SON', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Average_RCM_MAP_SON_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageDJFR, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1961-2005 - Average_RCM DJF', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Average_RCM_MAP_DJF_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageMAMR, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1961-2005 - Average_RCM MAM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Average_RCM_MAP_MAM_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageJJAR, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1961-2005 - Average_RCM JJA', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Average_RCM_MAP_JJA_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageSONG, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1961-2005 - Average_GCM_SON', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Average_GCM_MAP_SON', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageDJFG, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1961-2005 - Average_GCM DJF', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Average_GCM_MAP_DJF', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageMAMG, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1961-2005 - Average_GCM MAM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Average_GCM_MAP_MAM', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(AverageJJAG, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1961-2005 - Average_GCM JJA', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Average_GCM_MAP_JJA', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsSON, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1961-2005 - Observed SON', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Observed_MAP_SON_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsDJF, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1961-2005 - Observed DJF', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Observed_MAP_DJF_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsMAM, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1961-2005 - Observed MAM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Observed_MAP_MAM_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(ObsJJA, cmap=colourA, levels=np.arange(14,29,0.5), extend='both')
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas 1961-2005 - Observed JJA', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('Tas_Observed_MAP_JJA_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasE, cmap=colourB, levels=np.arange(-3,3,0.25), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas Bias 1990-2008 - Average_ERAINT', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasBIAS_Average_ERAINT_MAP_Annual_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasR, cmap=colourB, levels=np.arange(-3,3,0.25), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas Bias 1961-2005 - Average_RCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasBIAS_Average_RCM_MAP_Annual_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasG, cmap=colourB, levels=np.arange(-3,3,0.25), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas Bias 1961-2005 - Average_GCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasBIAS_Average_GCM_MAP_Annual', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasSONE, cmap=colourB, levels=np.arange(-3,3,0.25), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas Bias SON 1990-2008 - Average_ERAINT', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasBIAS_Average_ERAINT_MAP_SON_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasDJFE, cmap=colourB, levels=np.arange(-3,3,0.25), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas Bias DJF 1990-2008 - Average_ERAINT', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasBIAS_Average_ERAINT_MAP_DJF_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasMAME, cmap=colourB, levels=np.arange(-3,3,0.25), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas Bias MAM 1990-2008 - Average_ERAINT', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasBIAS_Average_ERAINT_MAP_MAM_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasJJAE, cmap=colourB, levels=np.arange(-3,3,0.25), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas Bias JJA 1990-2008 - Average_ERAINT', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasBIAS_Average_ERAINT_MAP_JJA_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasSONR, cmap=colourB, levels=np.arange(-3,3,0.25), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas Bias SON 1961-2005 - Average_RCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasBIAS_Average_RCM_MAP_SON_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasDJFR, cmap=colourB, levels=np.arange(-3,3,0.25), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas Bias DJF 1961-2005 - Average_RCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasBIAS_Average_RCM_MAP_DJF_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasMAMR, cmap=colourB, levels=np.arange(-3,3,0.25), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas Bias MAM 1961-2005 - Average_RCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasBIAS_Average_RCM_MAP_MAM_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasJJAR, cmap=colourB, levels=np.arange(-3,3,0.25), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas Bias JJA 1961-2005 - Average_RCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasBIAS_Average_RCM_MAP_JJA_H', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasSONG, cmap=colourB, levels=np.arange(-3,3,0.25), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas Bias SON 1961-2005 - Average_GCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasBIAS_Average_GCM_MAP_SON', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasDJFG, cmap=colourB, levels=np.arange(-3,3,0.25), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas Bias DJF 1961-2005 - Average_GCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasBIAS_Average_GCM_MAP_DJF', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasMAMG, cmap=colourB, levels=np.arange(-3,3,0.25), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas Bias MAM 1961-2005 - Average_GCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasBIAS_Average_GCM_MAP_MAM', bbox_inches='tight')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(lat_formatter)
    #plot data and set colour range
    plot = iplt.contourf(BiasJJAG, cmap=colourB, levels=np.arange(-3,3,0.25), extend='both') 
    #add colour bar index and a label
    plt.colorbar(plot, label='Celsius')
    #give map a title
    plt.title('Tas Bias JJA 1961-2005 - Average_GCM', fontsize=10)
    #save the image of the graph and include full legend
    plt.savefig('TasBIAS_Average_GCM_MAP_JJA', bbox_inches='tight')
    plt.show()
