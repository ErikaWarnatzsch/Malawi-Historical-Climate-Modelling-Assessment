...
#-------------------------------------------------------------------------
    ...
    fig.suptitle("Pr for Malawi 1990-2008", size='x-large')
    PLT.savefig('Pr_Taylor_ERAINT_Annual', bbox_inches='tight')
    PLT.show()
    ...
    fig.legend(dia.samplePoints,
               [ p.get_label() for p in dia.samplePoints ], numpoints=1, prop=dict(size='small'), bbox_to_anchor=(0.,1.02,1.,.102), loc=8, ncol=3, mode='expand', borderaxespad=0.)
    fig.suptitle("Pr for Malawi SON 1990-2008", size='x-large')
    PLT.savefig('Pr_Taylor_ERAINT_SON', bbox_inches='tight')
    PLT.show()
    ...
    fig.legend(dia.samplePoints,
               [ p.get_label() for p in dia.samplePoints ], numpoints=1, prop=dict(size='small'), bbox_to_anchor=(0.,1.02,1.,.102), loc=8, ncol=3, mode='expand', borderaxespad=0.)
    fig.suptitle("Pr for Malawi DJF 1990-2008", size='x-large')
    PLT.savefig('Pr_Taylor_ERAINT_DJF', bbox_inches='tight')
    PLT.show()
    ...
    fig.legend(dia.samplePoints,
               [ p.get_label() for p in dia.samplePoints ], numpoints=1, prop=dict(size='small'), bbox_to_anchor=(0.,1.02,1.,.102), loc=8, ncol=3, mode='expand', borderaxespad=0.)
    fig.suptitle("Pr for Malawi MAM 1990-2008", size='x-large')
    PLT.savefig('Pr_Taylor_ERAINT_MAM', bbox_inches='tight')
    PLT.show()
    ...
    fig.legend(dia.samplePoints,
               [ p.get_label() for p in dia.samplePoints ], numpoints=1, prop=dict(size='small'), bbox_to_anchor=(0.,1.02,1.,.102), loc=8, ncol=3, mode='expand', borderaxespad=0.)
    fig.suptitle("Pr for Malawi JJA 1990-2008", size='x-large')
    PLT.savefig('Pr_Taylor_ERAINT_JJA', bbox_inches='tight')
    PLT.show()
    ...
    fig.legend(dia.samplePoints,
               [ p.get_label() for p in dia.samplePoints ], numpoints=1, prop=dict(size='small'), bbox_to_anchor=(0.,1.02,1.,.102), loc=8, ncol=3, mode='expand', borderaxespad=0.)
    fig.suptitle("Pr for Malawi 1961-2005", size='x-large')
    PLT.savefig('Pr_Taylor_Annual', bbox_inches='tight')
    PLT.show()
    ...
    fig.legend(dia.samplePoints,
               [ p.get_label() for p in dia.samplePoints ], numpoints=1, prop=dict(size='small'), bbox_to_anchor=(0.,1.02,1.,.102), loc=8, ncol=3, mode='expand', borderaxespad=0.)
    fig.suptitle("Pr for Malawi SON 1961-2005", size='x-large')
    PLT.savefig('Pr_Taylor_SON', bbox_inches='tight')
    PLT.show()
    ...
    fig.legend(dia.samplePoints,
               [ p.get_label() for p in dia.samplePoints ], numpoints=1, prop=dict(size='small'), bbox_to_anchor=(0.,1.02,1.,.102), loc=8, ncol=3, mode='expand', borderaxespad=0.)
    fig.suptitle("Pr for Malawi DJF 1961-2005", size='x-large')
    PLT.savefig('Pr_Taylor_DJF', bbox_inches='tight')
    PLT.show()
    ...
    fig.legend(dia.samplePoints,
               [ p.get_label() for p in dia.samplePoints ], numpoints=1, prop=dict(size='small'), bbox_to_anchor=(0.,1.02,1.,.102), loc=8, ncol=3, mode='expand', borderaxespad=0.)
    fig.suptitle("Pr for Malawi MAM 1961-2005", size='x-large')
    PLT.savefig('Pr_Taylor_MAM', bbox_inches='tight')
    PLT.show()
    ...
    fig.legend(dia.samplePoints,
               [ p.get_label() for p in dia.samplePoints ], numpoints=1, prop=dict(size='small'), bbox_to_anchor=(0.,1.02,1.,.102), loc=8, ncol=3, mode='expand', borderaxespad=0.)
    fig.suptitle("Pr for Malawi JJA 1961-2005", size='x-large')
    PLT.savefig('Pr_Taylor_JJA', bbox_inches='tight')
    PLT.show()
