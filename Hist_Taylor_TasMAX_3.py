...
def main():
    ...
    fig.suptitle("TasMAX for Malawi 1990-2005", size='x-large')
    PLT.savefig('TasMAX_Taylor_Annual3', bbox_inches='tight')
    PLT.show()
    ...
    fig.legend(dia.samplePoints,
               [ p.get_label() for p in dia.samplePoints ], numpoints=1, prop=dict(size='small'), bbox_to_anchor=(0.,1.02,1.,.102), loc=8, ncol=3, mode='expand', borderaxespad=0.)
    fig.suptitle("TasMAX for Malawi SON 1990-2005", size='x-large')
    PLT.savefig('TasMAX_Taylor_SON3', bbox_inches='tight')
    PLT.show()
    ...
    fig.legend(dia.samplePoints,
               [ p.get_label() for p in dia.samplePoints ], numpoints=1, prop=dict(size='small'), bbox_to_anchor=(0.,1.02,1.,.102), loc=8, ncol=3, mode='expand', borderaxespad=0.)
    fig.suptitle("TasMAX for Malawi DJF 1990-2005", size='x-large')
    PLT.savefig('TasMAX_Taylor_DJF3', bbox_inches='tight')
    PLT.show()
    ...
    fig.legend(dia.samplePoints,
               [ p.get_label() for p in dia.samplePoints ], numpoints=1, prop=dict(size='small'), bbox_to_anchor=(0.,1.02,1.,.102), loc=8, ncol=3, mode='expand', borderaxespad=0.)
    fig.suptitle("TasMAX for Malawi MAM 1990-2005", size='x-large')
    PLT.savefig('TasMAX_Taylor_MAM3', bbox_inches='tight')
    PLT.show()
    ...
    fig.legend(dia.samplePoints,
               [ p.get_label() for p in dia.samplePoints ], numpoints=1, prop=dict(size='small'), bbox_to_anchor=(0.,1.02,1.,.102), loc=8, ncol=3, mode='expand', borderaxespad=0.)
    fig.suptitle("TasMAX for Malawi JJA 1990-2005", size='x-large')
    PLT.savefig('TasMAX_Taylor_JJA3', bbox_inches='tight')
    PLT.show()
